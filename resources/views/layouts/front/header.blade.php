<nav class="navbar  navbar-light px-4 align-items-end">
  ...
  <path fill-rule="evenodd" d="M7.5 8a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1H8.5V12a.5.5 0 0 1-1 0V8z"></path>
          ...
          <li class="nav-item">
            <a class="btn btn-sm btn-outline-info nav-link" href="/users/edit">
  ...
  <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"></path>
          ...
          <li class="nav-item">
          <a class="btn btn-sm btn-outline-info nav-link" href="{{ route('logout') }}"
