...
<main>
    <div class="container">
      ...
      <div class="projects-filter row justify-content-around">
          <div id="all" class="col-3 btn btn btn-outline-secondary btn-sm projects-filter-btn">
...
All projects</div>
          <div id="owner" class="col-3 btn btn btn-outline-secondary btn-sm projects-filter-btn">
...
Created by me</div>
          <div id="member" class="col-3 btn btn btn-outline-secondary btn-sm projects-filter-btn">
...
Shared with me</div>
      ...
      <div class="row mt-5">
          ...
          <div class="owner col-4 mb-4">
      <div class="card project_card">
        <div class="card-header bg-dark text-white ">
          <div class="row">
            <div class="col mr-auto">
              <a href="{{url('discus/'.$item->id)}}">
              <h5>{{$item->name}}</h5>
</a>              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M5.707 13.707a1 1 0 0 1-.39.242l-3 1a1 1 0 0 1-1.266-1.265l1-3a1 1 0 0 1 .242-.391L10.086 2.5a2 2 0 0 1 2.828 0l.586.586a2 2 0 0 1 0 2.828l-7.793 7.793zM3 11l7.793-7.793a1 1 0 0 1 1.414 0l.586.586a1 1 0 0 1 0 1.414L5 13l-3 1 1-3z"></path>
  <path fill-rule="evenodd" d="M9.854 2.56a.5.5 0 0 0-.708 0L5.854 5.855a.5.5 0 0 1-.708-.708L8.44 1.854a1.5 1.5 0 0 1 2.122 0l.293.292a.5.5 0 0 1-.707.708l-.293-.293z"></path>
  <path d="M13.293 1.207a1 1 0 0 1 1.414 0l.03.03a1 1 0 0 1 .03 1.383L13.5 4 12 2.5l1.293-1.293z"></path>
</svg>
...
<span class="badge badge-secondary">1</span>
        ...
        <div class="col-auto">
            <a class="btn btn-danger  btn-sm" data-confirm="Are you sure you want to delete this project?" rel="nofollow" data-method="delete" href="{{url('delete-project/'.$item->id)}}">
